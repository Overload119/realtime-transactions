...
module Gem::Requirement::CorrectHashForLambdaOperator
  # source://bundler/2.3.18/lib/bundler/rubygems_ext.rb#203
  def hash; end
end

module Gem::Requirement::OrderIndependentComparison
  # source://bundler/2.3.18/lib/bundler/rubygems_ext.rb#173
  def ==(other); end

  protected

  # source://bundler/2.3.18/lib/bundler/rubygems_ext.rb#185
  def _requirements_sorted?; end

  # source://bundler/2.3.18/lib/bundler/rubygems_ext.rb#191
